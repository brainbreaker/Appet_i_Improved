...
import com.sunshine.bbreaker.appet_i.CardCursorContract;
import com.sunshine.bbreaker.appet_i.R;
...
public class Tab1 extends Fragment {
    ...
    private void initCards() {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            if ((i % 6 == 0)) {
                card.resourceIdThumbnail = R.drawable.ghewar;
            } else if ((i % 6 == 1)) {
                card.resourceIdThumbnail = R.drawable.kalakand;
            } else if ((i % 6 == 2)) {
                card.resourceIdThumbnail = R.drawable.bikaneripapad;
            } else if ((i % 6 == 3)) {
                card.resourceIdThumbnail = R.drawable.mysorepak;
            } else if ((i % 6 == 4)) {
                card.resourceIdThumbnail = R.drawable.tilkeladdoo;
            }
    ...
    public class MyCardArrayMultiChoiceAdapter extends CardGridArrayMultiChoiceAdapter {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            inflater.inflate(R.menu.gridheader, menu);
            return true;
        }
...
//            }
    ...
    public class GplayGridCard extends Card {
        ...
        private void init() {
            ...
            header.setPopupMenu(R.menu.gridheader, new CardHeader.OnClickCardHeaderPopupMenuListener() {
                @Override
            ...
            if (resourceIdThumbnail > -1)
                ...
                thumbnail.setDrawableResource(R.drawable.ic_drawer);
